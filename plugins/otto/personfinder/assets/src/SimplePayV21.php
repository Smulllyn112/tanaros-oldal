...
trait Views
{
    public $formDetails = [
        ...
        'name' => 'SimplePayForm',
        'element' => 'button',
        'elementText' => 'SimplePay Fizetés megkezdése',
    ];
    ...
    public function getHtmlForm()
    {
        ...
        if (isset($this->returnData['paymentUrl']) && $this->returnData['paymentUrl'] != '') {
            $this->returnData['form'] = '



            <form action="' . $this->returnData['paymentUrl'] . '" method="GET" id="' . $this->formDetails['id'] . '" accept-charset="UTF-8">

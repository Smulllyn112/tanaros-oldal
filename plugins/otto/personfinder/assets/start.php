...
$trx->addItems(
    array(
        'ref' => '2',
        'title' => 'Ez egy termék név',
        'description' => 'Ez egy termék leírás',
        'amount' => '1',
        'price' => '0',
        'tax' => '0',
        )
...
// customer's name
//-----------------------------------------------------------------------------------------
$trx->addData('customer', 'Viharos Ottó');


// EMAIL
// customer's email
//-----------------------------------------------------------------------------------------
$trx->addData('customerEmail', 'viharos.otto@gmail.com');
...
// INVOICE DATA
//-----------------------------------------------------------------------------------------
$trx->addGroupData('invoice', 'name', 'Viharos Ottó');
